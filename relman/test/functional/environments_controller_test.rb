...
class EnvironmentsControllerTest < ActionController::TestCase
  ...
  test "should create environment" do
    assert_difference('Environment.count') do
      post :create, environment: { IP: @environment.IP, default: @environment.default, description: @environment.description, name: @environment.name }
    end
  ...
  test "should update environment" do
    put :update, id: @environment, environment: { IP: @environment.IP, default: @environment.default, description: @environment.description, name: @environment.name }
    assert_redirected_to environment_path(assigns(:environment))
  end
