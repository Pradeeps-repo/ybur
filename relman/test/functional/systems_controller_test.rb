...
class SystemsControllerTest < ActionController::TestCase
  ...
  test "should create system" do
    assert_difference('System.count') do
      post :create, system: { description: @system.description, name: @system.name, productversion: @system.productversion, relnum: @system.relnum }
    end
  ...
  test "should update system" do
    put :update, id: @system, system: { description: @system.description, name: @system.name, productversion: @system.productversion, relnum: @system.relnum }
    assert_redirected_to system_path(assigns(:system))
  end
